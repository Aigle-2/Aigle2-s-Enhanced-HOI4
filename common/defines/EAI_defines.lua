...
NDefines.NMilitary.EXPERIENCE_COMBAT_FACTOR = 0.05 -- Combat modifier given by xp ? Was 0.25 / modded 0.5
...
NDefines.NProduction.MIN_FIELD_TO_TRAINING_MANPOWER_RATIO = 0.3 --EAI / Vanilla 0.75
NDefines.NProduction.MIN_POSSIBLE_TRAINING_MANPOWER = 30000	--EAI / Vanilla 100000
